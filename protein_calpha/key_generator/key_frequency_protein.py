...
def protein_freq_table(directory, relative_path, header):
    ...
    for filename in os.listdir(directory):
        if filename.endswith('.keys_Freq_theta29_dist35'):  # Assuming the files have a .txt extension
    ...
    if header == 'yes':
        ...
        with open(relative_path+'protein_csv/localFeatureVect_theta29_dist35_NoFeatureSelection_keyCombine0_header.csv', 'w', newline='') as csvfile:
        ...
        with open(relative_path+'protein_csv/localFeatureVect_theta29_dist35_NoFeatureSelection_keyCombine0.csv', 'w', newline='') as csvfile:
            for protein_name, data in protein_data.items():
            # Without header code
